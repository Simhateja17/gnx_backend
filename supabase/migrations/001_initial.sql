...
CREATE TABLE agent_configs (
  ...
  follow_up_cadence TEXT DEFAULT '',
  icp_titles TEXT[] NOT NULL DEFAULT '{}',
  icp_company_sizes TEXT[] NOT NULL DEFAULT '{}',
  icp_target_industries TEXT[] DEFAULT '{}',
  icp_geos TEXT[] NOT NULL DEFAULT '{}',
  meeting_target INTEGER DEFAULT 15,
  deal_size TEXT DEFAULT '',
  sales_cycle TEXT DEFAULT '',
  booking_link TEXT,
  tools TEXT[] DEFAULT '{}',
  auto_approve_replies BOOLEAN NOT NULL DEFAULT false,
  daily_email_send_cap INTEGER NOT NULL DEFAULT 100,
