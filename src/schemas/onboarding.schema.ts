...
export const onboardingPostSchema = z.object({
  ...
  tone: z.enum(['consultative', 'direct', 'friendly', 'formal', 'challenger']).default('consultative'),
  hookStyle: z.enum(['pain_based', 'insight_based', 'social_proof', 'personalized_signal', 'question_led']).optional().default('pain_based'),
